...
export
  const SEASON_SCHEDULE: Schedule[] = [
    { id: 1, PlayingDate: new Date(2015,8,23), HomeTeam: 'Old Men United', AwayTeam: 'Kellies Kickers',
    ...
    { id: 4, PlayingDate: new Date(2015,9,1),HomeTeam: 'Kellies Kickers', AwayTeam: 'Blue Devils',
    ...
    { id: 9, PlayingDate: new Date(2015,9,12),HomeTeam: 'Kellies Kickers', AwayTeam: 'FC Dauntlesss',
